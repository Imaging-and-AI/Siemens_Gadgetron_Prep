...
template <typename T>
class CmrSashaT1T2Mapping : public CmrMultiParametricMapping<T>
{
public:
...
template <typename T>
class CmrSashaT1T2T1pMapping : public CmrMultiParametricMapping<T>
{
public:

    typedef CmrMultiParametricMapping<T> BaseClass;
    typedef CmrSashaT1T2T1pMapping<T> Self;
    ...
    CmrSashaT1T2T1pMapping();
    virtual ~CmrSashaT1T2T1pMapping();

    // ======================================================================================
    /// parameter for SASHA T1/T2/T1p mapping
    // ======================================================================================
    T max_t1_value_;
    T max_t2_value_;
    T max_t1p_value_;
