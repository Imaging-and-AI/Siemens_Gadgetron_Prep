...
docker build --network=host -t siemens_gadgetron_prep/gadgetron_siemens_ubuntu1604_nopython -f Siemens_Gadgetron_Prep/docker/incremental_ubuntu_1604/siemens_gadgetron_nopython/Dockerfile .
```
